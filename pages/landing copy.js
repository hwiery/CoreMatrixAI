    ...
    <div className={`min-h-screen bg-black text-white ${language === 'ko' ? 'korean' : 'english'}`}>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
              <Button
                ...
                className="bg-emerald-500 hover:bg-emerald-400 text-white px-8 py-4 text-lg font-medium rounded-lg transform hover:scale-105 transition-all duration-300 w-full sm:w-auto"
              >
      ...
      >
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Button 
            onClick={() => router.push('/contact')}
            className="bg-emerald-500 text-white hover:bg-emerald-400 px-8 py-4 text-lg font-medium rounded-lg transform hover:scale-105 transition-all duration-300"
          >
